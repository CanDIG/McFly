...
func MakePatientFileFromData(name string, data []PatientRecord) {
	...
	for i := 0; i < v.NumField(); i++ {
		...
		stringToFile += strings.ToLower(string(tag.Tag.Get("json"))) + "\t"
	}
...
func TranslatePatientData(m map[string]string) PatientRecord {
	...
	r.Age, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("AngiolymphaticInvasion")
	r.AngiolymphaticInvasion = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ClinicalAssessment")
	r.ClinicalAssessment = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("DfsMonths")
	r.DfsMonths = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("DfsStatus")
	r.DfsStatus = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Ethnicity")
	r.Ethnicity = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("LostToFollowup")
	r.LostToFollowup = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("LymphNodesExamined")
	r.LymphNodesExamined = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MethodOfInitialPathDiagnosis")
	r.MethodOfInitialPathDiagnosis = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MethodOfInitialPathDiagnosisOther")
	r.MethodOfInitialPathDiagnosisOther = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NewTumorEventAfterInitialTreatment")
	r.NewTumorEventAfterInitialTreatment = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NewTumorEventOtherSite")
	r.NewTumorEventOtherSite = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("OsMonths")
	r.OsMonths = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("OsStatus")
	r.OsStatus = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PathologicDistantSpread")
	r.PathologicDistantSpread = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PathologicSpreadIncidentalProstateCancer")
	r.PathologicSpreadIncidentalProstateCancer = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PatientID")
	r.PatientID = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PrimaryTumorPathologicSpread")
	r.PrimaryTumorPathologicSpread = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ProspectiveCollection")
	r.ProspectiveCollection = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Race")
	r.Race = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Sex")
	r.Sex = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SmokingHistory")
	r.SmokingHistory = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SmokingPackYears")
	r.SmokingPackYears, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SmokingYearStarted")
	r.SmokingYearStarted = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SmokingYearStopped")
	r.SmokingYearStopped = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Subtype")
	r.Subtype = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("YearOfDiagnosis")
	r.YearOfDiagnosis = m[strings.ToLower(string(tag.Tag.Get("json")))]
...
func TranslateSampleData(m map[string]string) SampleRecord {
	...
	r.BatchNumber, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("CancerTypeDetailed")
	r.CancerTypeDetailed, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("CompleteTCGAID")
	r.CompleteTCGAID, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ExtracapsularSpread")
	r.ExtracapsularSpread, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Grade")
	r.Grade, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("IfExtracapsularSpreadPresent")
	r.IfExtracapsularSpreadPresent, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("IncidentalProstateCancer")
	r.IncidentalProstateCancer, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MetastaticSite")
	r.MetastaticSite, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MetastaticSiteOther")
	r.MetastaticSiteOther, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NewTumorEventSite")
	r.NewTumorEventSite, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NewTumorEventType")
	r.NewTumorEventType, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NodesEx")
	r.NodesEx, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("OncotreeCode")
	r.OncotreeCode, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PatientID")
	r.PatientID, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PrimarySite")
	r.PrimarySite, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("PriorTumor")
	r.PriorTumor, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("RegionalNodesPathologicSpread")
	r.RegionalNodesPathologicSpread, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SampleID")
	r.SampleID, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TStage")
	r.TStage, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
...
func TranslateMutationData(m map[string]string) MutationRecord {
	...
	r.BAMFile, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Center")
	r.Center, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Chromosome")
	r.Chromosome, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Consequence")
	r.Consequence, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("DBSNPRS")
	r.DBSNPRS, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("DBSNPValStatus")
	r.DBSNPValStatus, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("EndPosition")
	r.EndPosition, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("EntrezGeneID")
	r.EntrezGeneID, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("HGVSc")
	r.HGVSc, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("HGVSp")
	r.HGVSp, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("HGVSpShort")
	r.HGVSpShort, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("HugoSymbol")
	r.HugoSymbol, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MatchedNormSampleBarcode")
	r.MatchedNormSampleBarcode, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MatchNormSeqAllele1")
	r.MatchNormSeqAllele1, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MatchNormSeqAllele2")
	r.MatchNormSeqAllele2, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MatchNormValidationAllele1")
	r.MatchNormValidationAllele1, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MatchNormValidationAllele2")
	r.MatchNormValidationAllele2, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("MutationStatus")
	r.MutationStatus, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NAltCount")
	r.NAltCount, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NCBIBuild")
	r.NCBIBuild, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("NRefCount")
	r.NRefCount, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ReferenceAllele")
	r.ReferenceAllele, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Score")
	r.Score, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Sequencer")
	r.Sequencer, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SequenceSource")
	r.SequenceSource, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("SequencingPhase")
	r.SequencingPhase, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("StartPosition")
	r.StartPosition, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("Strand")
	r.Strand, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TAltCount")
	r.TAltCount, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TRefCount")
	r.TRefCount, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TumorSampleBarcode")
	r.TumorSampleBarcode, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TumorSeqAllele1")
	r.TumorSeqAllele1, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TumorSeqAllele2")
	r.TumorSeqAllele2, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TumorValidationAllele1")
	r.TumorValidationAllele1, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("TumorValidationAllele2")
	r.TumorValidationAllele2, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ValidationMethod")
	r.ValidationMethod, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("ValidationStatus")
	r.ValidationStatus, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("VariantClassification")
	r.VariantClassification, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("VariantType")
	r.VariantType, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
	tag, _ = reflect.ValueOf(r).Type().FieldByName("VerificationStatus")
	r.VerificationStatus, _ = m[strings.ToLower(string(tag.Tag.Get("json")))]
